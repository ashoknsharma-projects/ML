...
### Train Model
def train_model(train_data_batches, num_epochs, validation_data_batches, early_stopping):
  print("Training model...")
  LOG_DIR_PATH = "drive/MyDrive/Dog Breed Identification/logs"
...
### Train Full Model
def train_full_model(full_data_batches, num_epochs, full_model_early_stopping):
